<template>
  <div>
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>业主服务管理</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card class="box-card" style="box-shadow: 0 0 2px rgba(0,0,0,0.1)">
      ...
      <el-table :data="users" border >
        ...
        <el-table-column prop="status" label="事务待处理" >
          <template #default="scope">
           <el-switch
...
<!--          {{scope.row}}-->
        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-button type="success" @click="removeUserById(scope.row.id)" :icon="Delete" circle />
          </template>
        </el-table-column>
      </el-table>
